...
public class DisintegrationTrap extends Trap {
	...
	public void activate() {
		...
		if (Dungeon.visible[ pos ]) {
			UNISTPixelDungeon.scene().add( new Beam.DeathRay( DungeonTilemap.tileCenterToWorld(pos-1),
					DungeonTilemap.tileCenterToWorld(pos+1)));
			UNISTPixelDungeon.scene().add(new Beam.DeathRay(DungeonTilemap.tileCenterToWorld(pos - Dungeon.level.width()),
