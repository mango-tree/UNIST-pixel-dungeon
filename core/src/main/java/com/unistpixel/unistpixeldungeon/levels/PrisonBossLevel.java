...
import com.unistpixel.unistpixeldungeon.items.keys.IronKey;
import com.unistpixel.unistpixeldungeon.levels.painters.MazePainter;
	...
	public void progress(){
		switch (state){
			...
			case FIGHT_ARENA:
				...
				vis.pos(11, 8);
				customTiles.add(vis);
				((GameScene) UNISTPixelDungeon.scene()).addCustomTile(vis);
