...
import com.unistpixel.unistpixeldungeon.FogOfWar;
import com.unistpixel.unistpixeldungeon.UNISTPixelDungeon;
import com.unistpixel.unistpixeldungeon.Statistics;
...
import com.unistpixel.unistpixeldungeon.effects.BannerSprites;
import com.unistpixel.unistpixeldungeon.effects.BlobEmitter;
import com.unistpixel.unistpixeldungeon.effects.EmoIcon;
import com.unistpixel.unistpixeldungeon.effects.Flare;
import com.unistpixel.unistpixeldungeon.effects.FloatingText;
import com.unistpixel.unistpixeldungeon.effects.Ripple;
import com.unistpixel.unistpixeldungeon.effects.SpellSprite;
...
import com.unistpixel.unistpixeldungeon.levels.features.Chasm;
import com.unistpixel.unistpixeldungeon.levels.traps.Trap;
...
import com.unistpixel.unistpixeldungeon.sprites.DiscardedItemSprite;
import com.unistpixel.unistpixeldungeon.sprites.HeroSprite;
import com.unistpixel.unistpixeldungeon.sprites.ItemSprite;
import com.unistpixel.unistpixeldungeon.ui.ActionIndicator;
import com.unistpixel.unistpixeldungeon.ui.AttackIndicator;
import com.unistpixel.unistpixeldungeon.ui.Banner;
import com.unistpixel.unistpixeldungeon.ui.BusyIndicator;
import com.unistpixel.unistpixeldungeon.ui.CustomTileVisual;
import com.unistpixel.unistpixeldungeon.ui.GameLog;
import com.unistpixel.unistpixeldungeon.ui.HealthIndicator;
import com.unistpixel.unistpixeldungeon.ui.LootIndicator;
import com.unistpixel.unistpixeldungeon.ui.QuickSlotButton;
import com.unistpixel.unistpixeldungeon.ui.ResumeIndicator;
import com.unistpixel.unistpixeldungeon.ui.StatusPane;
import com.unistpixel.unistpixeldungeon.ui.TerrainFeaturesTilemap;
import com.unistpixel.unistpixeldungeon.ui.Toast;
...
import com.unistpixel.unistpixeldungeon.windows.WndBag.Mode;
import com.unistpixel.unistpixeldungeon.windows.WndGame;
import com.unistpixel.unistpixeldungeon.windows.WndHero;
import com.unistpixel.unistpixeldungeon.windows.WndInfoCell;
import com.unistpixel.unistpixeldungeon.windows.WndInfoItem;
import com.unistpixel.unistpixeldungeon.windows.WndInfoMob;
import com.unistpixel.unistpixeldungeon.windows.WndInfoPlant;
import com.unistpixel.unistpixeldungeon.windows.WndInfoTrap;
import com.unistpixel.unistpixeldungeon.windows.WndMessage;
import com.unistpixel.unistpixeldungeon.windows.WndOptions;
import com.unistpixel.unistpixeldungeon.windows.WndStory;
import com.unistpixel.unistpixeldungeon.windows.WndTradeItem;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		UNISTPixelDungeon.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + UNISTPixelDungeon.zoom(), maxZoom));
	...
	public static void layoutTags() {
		...
		float tagLeft = UNISTPixelDungeon.flipTags() ? 0 : uiCamera.width - scene.attack.width();

		if (UNISTPixelDungeon.flipTags()) {
