...
import com.unistpixel.unistpixeldungeon.ui.ChangesButton;
import com.unistpixel.unistpixeldungeon.ui.ExitButton;
import com.unistpixel.unistpixeldungeon.ui.LanguageButton;
import com.unistpixel.unistpixeldungeon.ui.PrefsButton;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		DashboardItem btnAbout = new DashboardItem( Messages.get(this, "about"), 1 ) {
			@Override
			protected void onClick() {
				UNISTPixelDungeon.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnRankings = new DashboardItem( Messages.get(this, "rankings"), 2 ) {
			@Override
			protected void onClick() {
				UNISTPixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		add( btnRankings );
