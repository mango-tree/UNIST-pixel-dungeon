...
public class WelcomeScene extends PixelScene {
	...
	public void create() {
		...
		final int previousVersion = UNISTPixelDungeon.version();

		if (UNISTPixelDungeon.versionCode == previousVersion) {
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				UNISTPixelDungeon.switchScene(TitleScene.class);
			}
		};
		...
		if (previousVersion != 0){
			DarkRedButton changes = new DarkRedButton(Messages.get(this, "changelist")){
				...
				protected void onClick() {
					super.onClick();
					updateVersion(previousVersion);
					UNISTPixelDungeon.switchScene(ChangesScene.class);
				}
			};
		...
		} else if (previousVersion <= UNISTPixelDungeon.versionCode) {
	...
	private void updateVersion(int previousVersion){
		...
		UNISTPixelDungeon.version(UNISTPixelDungeon.versionCode);
	}
