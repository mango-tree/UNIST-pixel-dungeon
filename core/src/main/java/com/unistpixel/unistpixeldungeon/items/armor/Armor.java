...
import com.unistpixel.unistpixeldungeon.actors.hero.HeroClass;
import com.unistpixel.unistpixeldungeon.effects.Speck;
import com.unistpixel.unistpixeldungeon.items.BrokenSeal;
import com.unistpixel.unistpixeldungeon.items.EquipableItem;
import com.unistpixel.unistpixeldungeon.items.Item;
import com.unistpixel.unistpixeldungeon.items.armor.curses.AntiEntropy;
import com.unistpixel.unistpixeldungeon.items.armor.curses.Corrosion;
import com.unistpixel.unistpixeldungeon.items.armor.curses.Displacement;
import com.unistpixel.unistpixeldungeon.items.armor.curses.Metabolism;
import com.unistpixel.unistpixeldungeon.items.armor.curses.Multiplicity;
import com.unistpixel.unistpixeldungeon.items.armor.curses.Stench;
import com.unistpixel.unistpixeldungeon.items.armor.glyphs.Affection;
...
import com.unistpixel.unistpixeldungeon.items.armor.glyphs.Camouflage;
import com.unistpixel.unistpixeldungeon.items.armor.glyphs.Entanglement;
...
import com.unistpixel.unistpixeldungeon.items.armor.glyphs.Potential;
import com.unistpixel.unistpixeldungeon.items.armor.glyphs.Repulsion;
...
import com.unistpixel.unistpixeldungeon.items.armor.glyphs.Thorns;
...
public class Armor extends EquipableItem {
	...
	public String info() {
		...
		if (levelKnown) {
			info += "\n\n" + Messages.get(Armor.class, "curr_absorb", DRMin(), DRMax(), STRReq()*10);
			...
			info += "\n\n" + Messages.get(Armor.class, "avg_absorb", DRMin(0), DRMax(0), STRReq(0)*10);
