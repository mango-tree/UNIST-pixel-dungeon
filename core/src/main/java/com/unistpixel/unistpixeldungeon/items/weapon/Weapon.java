 ...
 */
package com.unistpixel.unistpixeldungeon.items.weapon;
...
import com.unistpixel.unistpixeldungeon.items.weapon.curses.Annoying;
import com.unistpixel.unistpixeldungeon.items.weapon.curses.Displacing;
import com.unistpixel.unistpixeldungeon.items.weapon.curses.Exhausting;
import com.unistpixel.unistpixeldungeon.items.weapon.curses.Fragile;
import com.unistpixel.unistpixeldungeon.items.weapon.curses.Sacrificial;
import com.unistpixel.unistpixeldungeon.items.weapon.curses.Wayward;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Blazing;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Chilling;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Dazzling;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Eldritch;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Grim;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Lucky;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Projecting;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Shocking;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Stunning;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Unstable;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Vampiric;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Venomous;
import com.unistpixel.unistpixeldungeon.items.weapon.enchantments.Vorpal;
