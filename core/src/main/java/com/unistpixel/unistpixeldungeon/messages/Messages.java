 ...
 */
package com.unistpixel.unistpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.unistpixel.unistpixeldungeon.messages.actors.actors",
			"com.unistpixel.unistpixeldungeon.messages.items.items",
			"com.unistpixel.unistpixeldungeon.messages.levels.levels",
			"com.unistpixel.unistpixeldungeon.messages.plants.plants",
			"com.unistpixel.unistpixeldungeon.messages.scenes.scenes",
			"com.unistpixel.unistpixeldungeon.messages.ui.ui",
			"com.unistpixel.unistpixeldungeon.messages.windows.windows",
			"com.unistpixel.unistpixeldungeon.messages.misc.misc"
	};

	static{
		setup(UNISTPixelDungeon.language());
	}
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.unistpixel.unistpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
